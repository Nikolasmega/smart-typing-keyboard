...
**Step 5.** Choose your **typing duration**: 2, 5, 10, 15, 20, 30, 45 minutes, 1 hour, or Pro.
...
**Шаг 5.** Выбери **время печати**: 2, 5, 10, 15, 20, 30, 45 минут, 1 час или Pro.
...
- **Multiple Speed Presets**:
  - **Custom Durations**: Set target time limits (2, 5, 10, 15, 20, 30, 45, 60 minutes or Pro) to stretch your text entry evenly across the duration.
